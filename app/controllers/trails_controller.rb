class TrailsController < ApplicationController
  ...
  private
    ...
    def trail_params
      params.require(:trail).permit(:name, :distance, :route_id, :difficulty_level, :terrain, :elevation, :map_image, :overview, :header_image, :image_one, :image_two, :image_three, :handy_hint, :trail_icon)
    end
end
