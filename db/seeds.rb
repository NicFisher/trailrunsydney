...
Trail.create(:name => "Bantry Bay", :difficulty_level => "Hard", :route_id => 7917247, :distance => "5.7 KM", :terrain => "Technical Single Trail", :elevation => 127, :overview => "Starting and finishing at Ararat Reserve, this 6km loop will take you to Seaforth Oval, down to Bantry Bay water and back to finish with a spectacular view looking over the water. Although this trail is only a 6km loop, it's very technical with several stairs and a big climb to finish, so don’t expect to be running any PBs on this one.", :header_image => "bantry_bay_edited.jpg", :image_one => "bantry_bay_trail.jpg", :handy_hint => "About 200 metres after the bottom of the stairs, down near the water, it will look like the trail ends at a small creek. Jump over the creek, climb the rock to the left and you'll see the trail continues.")

Trail.create(:name => "North Head", :difficulty_level => "Medium", :route_id => 7917301, :distance => "10 KM", :terrain => "Single Trail, Fire Trail and Road", :elevation => 247, :overview => "With some of the best views in Sydney, this is a must do run! Taking you from Manly Beach to Fairfax Lookout and back down. It has it all - road, fire trail, stairs and single trail.", :header_image => "north_head_main2.jpg", :image_one => "north_head_trail.jpg", :handy_hint => "Definitely worth doing this run early in the morning when the sun is rising.")
